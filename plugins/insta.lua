...
local function instagramUser(msg, query)
	...
	local file_paths = download_to_file(user.data.profile_picture,"insta.webp")    -- enable this line if you want to send profile photo as sticker
	...
	send_document(receiver, file_paths, rmtmp_cb, cb_extra)  -- enable this line if you want to send profile photo as sticker
